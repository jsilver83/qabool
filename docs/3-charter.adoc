...
in asp.net and it needs some enhancements to cover all type of reports.
...
* accept the agreements before registration
...
* accept withdrawal agreement,
* withdrawal form,
* print medical report,
* print admission letters,
* print two letters belong to student housing,
