...
* student dashboard.
* calculate GPA.
* student results, student confirmation,
...
=== For Student Affairs
* manage schedule for orientation course.
* atendance for orientation week.
* atendance for uneversity preparation course.
...
In 3 months and it will start from 01/03/2017 to 30/05/2017.
...
[cols="1,8"]
|==================================================
| Name        | Dr. Ahmed Khayyat
| Designation | Director General,  Information System
