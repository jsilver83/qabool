= Software Requirements Specification for Qubool
...
of the requirements for _Qubool_.
...
_Qubool_ shall enable students to apply to enroll at KFUPM.
...
[[context]]
.Phase 1 process
image::images/AdmissionBP-1.svg[]

Phase 2 will be for admission results as follows:

[[context]]
.Phase 2 process
image::images/AdmissionBP-2.svg[]
...
uploaded documents and data entered.

Reviewer::
Reviewer can review entered students' information and documents and correct
mistakes if any.
...
Registrar::
Like Student affairs department, Registrar office will have access to some BI
reports only.
...
_Qubool_ depends on Yesser GSB to fetch students high-school and Quadrat/Tahsili
tests data.
