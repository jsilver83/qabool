...
* Complete information with reading all agreements (Form 2)
...
There are three phases in the admission process at KFUPM. Phase 1 will
be the registration phase and it will be open to all high-school students:

[[context]]
.Phase 1 process
image::images/AdmissionBP-1.jpg[]

Phase 2 will be student confirmation and completing information:

[[context]]
.Phase 2 process
image::images/AdmissionBP-2.jpg[]
...
[[context]]
.Phase 3 process
image::images/AdmissionBP-3.jpg[]

Phase 4 Orientation week
