...
urlpatterns = [
    path('login/', general_views.index, name='login'),
    ...
    path('check-if-admitted/', general_views.check_if_student_is_admitted, name='check_if_student_is_admitted'),
    path('mark-as-attended/', general_views.mark_student_as_attended, name='mark_student_as_attended'),
    path('withdrawal-letter/', phase2_views.withdrawal_letter, name='withdrawal_lette'),
    path('withdraw/', phase2_views.WithdrawView.as_view(), name='withdraw'),
    path('medical-letter/', phase3_views.AdmissionLetters.as_view(), name='medical_lette'),
    path('admission-letter/', phase3_views.AdmissionLetters.as_view(), name='admission_lette'),
    ...
    path('student-area/', general_views.student_area, name='student_area'),
