...
urlpatterns = [
    ...
    url(r'^medicalletter/$', phase3_views.AdmissionLetters.as_view(), name='medical_letter'),
    url(r'^admissionletter/$', phase3_views.AdmissionLetters.as_view(), name='admission_letter'),
    url(r'^printdocuments2/$', phase3_views.AdmissionLetters.as_view(), name='print_documents_after_phase3'),
    url(r'^printdocuments/$', phase3_views.AdmissionLetters.as_view(), name='print_documents'),
    ...
    url(r'^uploaddocumentsincomplete/$', phase2_views.UploadMissingDocumentsView.as_view(),
    ...
    url(r'^uploaddocuments/$', phase2_views.UploadDocumentsView.as_view(), name='upload_documents'),
    ...
    url(r'^transfer/$', phase2_views.TransferView.as_view(), name='transfer'),
